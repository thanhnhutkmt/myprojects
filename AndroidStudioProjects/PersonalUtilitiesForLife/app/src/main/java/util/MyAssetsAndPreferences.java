...
public class MyAssetsAndPreferences {
    ...
    public static String getStringFromPreferences(Context a, String key) {
        SharedPreferences sp = a.getSharedPreferences(AppConstant.DBNAME, Activity.MODE_PRIVATE);
        return sp.getString(key, "");
    }

    public static float getFloatFromPreferences(Context a, String key) {
        SharedPreferences sp = a.getSharedPreferences(AppConstant.DBNAME, Activity.MODE_PRIVATE);
        return sp.getFloat(key, 0);
    }

    public static Set<String> getSetFromPreferences(Context a, String key) {
        SharedPreferences sp = a.getSharedPreferences(AppConstant.DBNAME, Activity.MODE_PRIVATE);
        return sp.getStringSet(key, null);
    }

    public static boolean saveToPreferences(Context a, String key, String value) {
        SharedPreferences sp = a.getSharedPreferences(AppConstant.DBNAME, Activity.MODE_PRIVATE);
