package util.winzipaes.impl;

import static util.winzipaes.impl.ByteArrayHelper.toInt;
import static util.winzipaes.impl.ByteArrayHelper.toLong;
import static util.winzipaes.impl.ByteArrayHelper.toShort;
