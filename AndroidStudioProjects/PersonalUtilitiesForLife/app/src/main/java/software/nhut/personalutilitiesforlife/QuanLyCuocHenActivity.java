...
public class QuanLyCuocHenActivity extends AppCompatActivity {
    ...
    public static final String SAVETEMPNAME1 = "temp1.sav";
    public static final String SAVETEMPNAME2 = "temp2.sav";
    ...
    public void addControls() {
        ...
        thisFeatureFolder = getApplicationInfo().dataDir
                + File.separator + AppConstant.THUMUC_QUANLY_CUOCHEN;
    ...
    class readWriteTask extends AsyncTask<Integer, Integer, Void> {
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            if (writeTask) {
                ...
                if (this.list != null && this.list.size() > 0)
                    updateListView(QuanLyCuocHenActivity.ADD, (List<CuocHen>) this.list, -1);
                pd.setProgress(values[0]);
            }
        }
        ...
        protected Void doInBackground(Integer... params) {
            if (writeTask) {
                ...
                List<?> listtemp = MyFileIO.loadData(path, SAVETEMPNAME2);
                if (listtemp == null || listtemp.size() == 0) listtemp = MyFileIO.loadData(path, SAVETEMPNAME1);
