...
public class QuanLyTinNhanActivity extends AppCompatActivity {
    ...
    */
    ...
    private final int WARNINGLEVEL = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String PSSCHK = getIntent().getStringExtra(AppConstant.PASSCHECK);
        if (PSSCHK == null || !PSSCHK.equals(AppConstant.PASSCHECKVALUE)) System.exit(0);
    ...
    private void initialize() {
        ...
        timer = new CountDownTimer(1000*60, 1000*2) {
            @Override public void onTick(long millisUntilFinished) {
                timeout++;
//                if (timeout > WARNINGLEVEL)
                Toast.makeText(QuanLyTinNhanActivity.this, Integer.toString(timeout),
                                Toast.LENGTH_SHORT).show();
                if (timeout > WARNINGLEVEL + 3) finish();
            }
...
//                while(timeout++ < WARNINGLEVEL + 3) {
////                    if (timeout > 4)
//                    QuanLyTinNhanActivity.this.runOnUiThread(new Runnable() {
//                        @Override
//                        public void run() {
//                            Toast.makeText(QuanLyTinNhanActivity.this, Integer.toString(timeout),
//                                Toast.LENGTH_SHORT).show();
...
//        }).start();
    ...
    private void xoaPhoneSim() {
        MyDialog.showDeleteConfirmDiaLog(this, R.string.AlertDialog_title_Delete_Confirm,
            R.string.AlertDialog_body_Delete_Confirm, new InputData() {
                @Override public Object inputData(Object o) {
                    ...
                    if (o instanceof AlertDialog) {
                        MyPhone.removeAllCallLogsPS(QuanLyTinNhanActivity.this);
                        MyPhone.removeAllContactsPS(QuanLyTinNhanActivity.this);
                        MyPhone.removeAllMessagesPS(QuanLyTinNhanActivity.this);
...
//        la.set(0, lps.get(0)); // uncomment this and run merge with phone and sim to add new fixed group in Spinner
    ...
    private void taoContactMoi() {
        if (index == 0)
            MyDialog.showContactDialog(QuanLyTinNhanActivity.this,
                R.string.AlertDialog_title_quanlytinnhan_editcontact, null, new InputData() {
                @Override public Object inputData(Object o) {return null;}
                @Override public void inputData(String s) {}
                @Override public void inputData(String s, int color) {}
                @Override public void inputData(String... s) {}
