...
public class CustomViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final AndroidATCView myView = (AndroidATCView)(rootView.findViewById(R.id.androidATCView));
        myView.setmSquareCol(Color.BLUE);
        myView.setmLabelCol(Color.YELLOW);
        myView.setmSquareText("Press me");
        myView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myView.setmSquareCol(Color.GREEN);
                myView.setmLabelCol(Color.MAGENTA);
