package com.example.nhut.projectkaraoke;
...
import com.example.nhut.adapter.MusicAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void nhapThongTinApp() {
        String info = "Version 1.0\nTác giả : Lưu Thành Nhựt\nAll rights reserved 2016";
        txtThongTinApp.setText(info);
    }
}
