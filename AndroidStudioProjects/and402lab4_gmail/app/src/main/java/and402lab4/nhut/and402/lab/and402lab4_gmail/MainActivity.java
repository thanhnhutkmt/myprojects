package and402lab4.nhut.and402.lab.and402lab4_gmail;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cleanCache();
        lv = (ListView) findViewById(R.id.listviewemailaccount);
        AlertDialog d = new AlertDialog.Builder(this)
            .setTitle("Which one ?").setMessage("Which one do you want to use?")
            .setNegativeButton("GooglePeopleAPIWEBAPI", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    GooglePeopleAPIWEBAPI();
                }
            })
            .setPositiveButton("GoogleAPI", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    GoogleAPI();
                }
