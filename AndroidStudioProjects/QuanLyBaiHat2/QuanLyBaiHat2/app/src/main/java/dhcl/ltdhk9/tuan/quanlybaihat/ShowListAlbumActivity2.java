...
public class ShowListAlbumActivity2 extends ListActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                ShowListAlbumActivity2.this.finish();
            }
        });
    }
    ...
    public void updateUI()
    {
        ...
        if(database!=null)
        {
            ...
            cursor.close();
            MySimpleArrayAdapter adapter=new MySimpleArrayAdapter(ShowListAlbumActivity2.this, R.layout.my_layout_for_show_list_data, list);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Toast.makeText(ShowListAlbumActivity2.this,"View->"+ list.get(position).toString(), Toast.LENGTH_LONG).show();
    }
