        ...
        <div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="col-md-8 col-sm-7 col-xs-12 column">
                    ...
                    <div class="form-box">
                    	<form:form id="feedbackform" modelAttribute="msg">
                            <div class="row clearfix">                                 
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                	<div class="field-label">Nội dung</div>
                                	<form:textarea path="msg" rows="3" cols="47"/>
                                </div>                         
                            </div>
                            <div align="right"><button id="buttongui" class="normal-btn theme-btn" formaction="insertmessage.controller">Gửi</button></div>
                        </form:form>
